...
> **Model: Most capable** — architecture decisions require deep trade-off reasoning. Before starting, tell the user: "Before we begin, switch to your **most capable model** (e.g. Opus, o3, Claude) in your AI tool's model selector. Architecture needs the deepest reasoning. Let me know when you've switched and I'll start." **Wait for the user to confirm before proceeding.**

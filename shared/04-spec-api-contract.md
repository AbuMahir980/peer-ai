...
> **Model: Opus 4.6** — API contracts require cross-cutting reasoning across FE, BE, and external APIs. Before starting, tell the user: "Before we begin, switch to **Opus 4.6** in your AI tool's model selector. API contract design needs the deepest reasoning. Let me know when you've switched and I'll start." **Wait for the user to confirm before proceeding.**

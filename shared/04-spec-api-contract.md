...
> **Model: Most capable** — API contracts require cross-cutting reasoning across FE, BE, and external APIs. Before starting, tell the user: "Before we begin, switch to your **most capable model** (e.g. Opus, o3, Claude) in your AI tool's model selector. API contract design needs the deepest reasoning. Let me know when you've switched and I'll start." **Wait for the user to confirm before proceeding.**

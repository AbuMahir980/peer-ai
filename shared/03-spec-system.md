...
> **Model: Opus 4.6** — user stories and acceptance criteria require full system context. Before starting, tell the user: "Before we begin, switch to **Opus 4.6** in the model picker (bottom-left of the chat panel). Spec writing needs precise reasoning. Let me know when you've switched and I'll start." **Wait for the user to confirm before proceeding.**
